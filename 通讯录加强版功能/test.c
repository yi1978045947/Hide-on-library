...
#include"header.h"
//void InitContact(struct Contact* pc) //静态的版本初始化通讯录
//{
//	pc->sz = 0;
...
void InitContact(struct Contact* pc)  //动态的版本初始化通讯录，实现通讯录的动态增长
{
	pc->sz = 0;
...
//void AddContact(struct Contact* pc) //静态版本的增加通讯录信息
//{
//	if (pc->sz == MAX)
//	{
//		printf("通讯录已满，无法加入信息!\n");
